...
/*
  ==============================================================================
    ...
    Plotter.h
    Created: 11 Feb 2023 10:30:27am
    Author:  jkokosa
...
public:
	Plotter(juce::Rectangle<float> area)
	{
		setArea(area);
	...
	Plotter(juce::Rectangle<int> area)
	{
		//
		juce::Rectangle<float> areaFloat;
		//

		areaFloat.setX(area.getX());
		areaFloat.setY(area.getY());
		areaFloat.setWidth(area.getWidth());
		areaFloat.setHeight(area.getHeight());
